...
namespace Converters
{
    ...
    /// Unix CPP converter
    /// </summary>
    public class UnixCPPConverter : ICodeConverter
    {
        ...
        {
            get { return UnixCPPConverter.rootStructureType; }
        }
        ...
        {
            get { return UnixCPPConverter.rootStructureInstance; }
        }
        ...
        private string IndentSource(string source)
        {
            ...
            foreach (Match m in matches)
            {
                if (m.Success)
                {
                    output += UnixCPPConverter.IndentString + m.Groups[1].Value + Environment.NewLine;
                }
            }
            return output;
        }
