...
namespace Converters
{
    ...
    /// Java converter
    /// </summary>
    public class JavaConverter : ICodeConverter
    {
        ...
        {
            get { return JavaConverter.rootStructureType; }
        }
        ...
        {
            get { return JavaConverter.rootStructureInstance; }
        }
        ...
        private string IndentSource(string source)
        {
            ...
            foreach (Match m in matches)
            {
                if (m.Success)
                {
                    output += JavaConverter.IndentString + m.Groups[1].Value + Environment.NewLine;
                }
            }
            return output;
        }
