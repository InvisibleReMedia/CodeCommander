...
namespace Converters
{
    ...
    /// Perl converter
    /// </summary>
    public class PerlConverter : ICodeConverter
    {
        ...
        /// </summary>
        public static readonly string rootStructureType = "RootType";
            /// <summary>
            /// Indicates the first instance
            /// </summary>
        public static readonly string rootStructureInstance = "Root";
        #endregion
        ...
        {
            get { return PerlConverter.rootStructureType; }
        }
        ...
        {
            get { return PerlConverter.rootStructureInstance; }
        }
        ...
        private string IndentSource(string source)
        {
            ...
            foreach (Match m in matches)
            {
                if (m.Success)
                {
                    output += PerlConverter.IndentString + m.Groups[1].Value + Environment.NewLine;
                }
            }
            return output;
        }
