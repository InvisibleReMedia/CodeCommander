...
namespace Converters
{
    ...
    /// CSharp Converter
    /// </summary>
    public class CSharpConverter : ICodeConverter
    {
        ...
        {
            get { return Languages.MicrosoftCSharp; }
        }
        ...
        {
            get { return CSharpConverter.rootStructureType; }
        }
        ...
        {
            get { return CSharpConverter.rootStructureInstance; }
        }
        ...
        private string IndentSource(string source)
        {
            ...
            foreach (Match m in matches)
            {
                if (m.Success)
                {
                    output += CSharpConverter.IndentString + m.Groups[1].Value + Environment.NewLine;
                }
            }
            return output;
        }
