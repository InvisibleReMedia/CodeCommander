...
namespace Converters
{
    ...
    /// </summary>
    public class MacOSCPPConverter : ICodeConverter
    {
        ...
        {
            get { return MacOSCPPConverter.rootStructureType; }
        }
        ...
        {
            get { return MacOSCPPConverter.rootStructureInstance; }
        }
        ...
        private string IndentSource(string source)
        {
            ...
            foreach (Match m in matches)
            {
                if (m.Success)
                {
                    output += MacOSCPPConverter.IndentString + m.Groups[1].Value + Environment.NewLine;
                }
            }
            return output;
        }
