...
namespace o2Mate
{
    ...
    internal class EndProcess : ICompiler
    {
        ...
        public void Display(BindingList<DisplayElement> list, Node<ICompiler> node, bool forcedIndent, ref int indent)
        {
            ...
            list.Add(new DisplayElement(this.TypeName, "displayEndProcess", new object[] { this.processName, this.indent.ToString(), false }));
        }
        ...
        public void DisplayReadOnly(BindingList<DisplayElement> list, Node<ICompiler> node, bool forcedIndent, ref int indent)
        {
            ...
            list.Add(new DisplayElement(this.TypeName, "displayEndProcess", new object[] { this.processName, this.indent.ToString(), true }));
        }
        ...
        {
            writer.WriteStartElement("endprocess");
            if (this.indent > 0)
        ...
        {
            proc.CurrentProject.Add(new ProjectItem(proc.Name, proc.CurrentPositionExecution, "end process", this.processName));
        }
