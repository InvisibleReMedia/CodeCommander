...
namespace o2Mate
{
    ...
    internal class Label : ICompiler
    {
        ...
        public void Display(BindingList<DisplayElement> list, Node<ICompiler> node, bool forcedIndent, ref int indent)
        {
            ...
            list.Add(new DisplayElement(this.TypeName, "displayLabel", new object[] { this.name, this.indent.ToString(), false }));
        }
        ...
        public void DisplayReadOnly(BindingList<DisplayElement> list, Node<ICompiler> node, bool forcedIndent, ref int indent)
        {
            ...
            list.Add(new DisplayElement(this.TypeName, "displayLabel", new object[] { this.name, this.indent.ToString(), true }));
        }

        public void Update(System.Windows.Forms.HtmlElement elem)
        {
            Int32.TryParse(elem.GetAttribute("indent"), out this.indent);
            this.name = this.GetElementByName(elem, "label").InnerText;
        }
        ...
        {
            proc.CurrentProject.Add(new ProjectItem(proc.Name, proc.CurrentPositionExecution, "label", this.Name));
        }
