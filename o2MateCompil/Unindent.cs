...
namespace o2Mate
{
    ...
    internal class Unindent : ICompiler, ILanguageConverter
    {
        ...
        public void Display(BindingList<DisplayElement> list, Node<ICompiler> node, bool forcedIndent, ref int indent)
        {
            ...
            list.Add(new DisplayElement(this.TypeName, "displayUnindent", new object[] { this.indent.ToString(), false }));
        }
        ...
        public void DisplayReadOnly(BindingList<DisplayElement> list, Node<ICompiler> node, bool forcedIndent, ref int indent)
        {
            ...
            list.Add(new DisplayElement(this.TypeName, "displayUnindent", new object[] { this.indent.ToString(), true }));
        }
        ...
        {
            writer.WriteStartElement("unindent");
            if (this.indent > 0)
        ...
        {
            converter.CurrentFunction.AddToSource("Unindent(" + MicrosoftCPPConverter.Escape(this.defaultWriter) + ");" + Environment.NewLine);
        }
